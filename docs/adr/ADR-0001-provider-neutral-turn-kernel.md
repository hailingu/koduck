...
| --- | --- | --- | --- | --- | --- |
| A-1 | ADR approved | An eligible non-author approver, approval time, and exact `Approval Evidence: Approve` are recorded; any optional Approval Context Revision is informational, non-binding, and exactly represents the approved document | ADR metadata | Complete | `@linhai` identified ADR-0001 and supplied exact `Approve` for Review `4913815805`; metadata records `2026-08-12T15:55:49+08:00`. No Approval Context Revision is recorded because no immutable revision yet represents the approved content. |
