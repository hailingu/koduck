...
- Decomposition review at `a7b6faa`: `sqlx_executor.rs` is 742 physical lines
  and `postgres.rs` is 413 physical lines, both above the 400-line review
