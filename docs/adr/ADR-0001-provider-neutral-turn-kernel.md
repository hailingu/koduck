...
- **Approval Time [Conditionally Required — Decision Status is or has been `Accepted`]**: 2026-08-12T16:25:02+08:00
...
| CT-8 | Initial or mid-Turn durability outage, including an accepted control-state read outage, publishes no uncommitted state and returns `durability-unavailable`. | AC-8; `control_read_outage_enters_failed_recovery_handoff` |
