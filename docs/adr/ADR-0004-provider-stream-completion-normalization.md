...
- Post-implementation decomposition review at `6f5aa2c5edf7e63495204d5a2673eca21235f289`,
  ...
  `cand_2_runner_tools.rs` (1507, from 1370) and `cand_1_contract.rs` (757,
  from 623), each retaining one contract family (C-5 runner tool servicing;
  owned REST/SSE v1 contract) whose new rows are the ADR-0004 acceptance
  tests plus their shared frame-scripted harness; `openai_provider.rs` (597)
  and `provider_stream_lifecycle.rs` (420) remain below the threshold. All
