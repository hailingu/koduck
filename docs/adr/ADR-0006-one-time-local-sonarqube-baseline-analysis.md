...
**Affected paths**: `docs/adr/ADR-0006-one-time-local-sonarqube-baseline-analysis.md`;
...
- [ ] Move this file to `archive/ADR-0006-one-time-local-sonarqube-baseline-analysis.md`
      under `docs/adr/`.
