...
| --- | --- | --- | --- | --- |
| T-1 | Move mandatory analysis to push, remove commit-only machinery, and prove preserved admission plus reduced execution | PV-1 through PV-7 at the affected paths below | Not Started | Pending — implementation not started |
