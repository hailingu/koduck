...
| OCR | OCR-0005 | Local SonarQube Accepted-Record Reliability Verification | Accepted | In Progress | Project | `docs/adr/ADR-0009-accepted-record-validator-reliability.md`, subtask T-2 | `docs/adr/ocr/OCR-0005-local-sonarqube-accepted-record-reliability-verification.md` | None |
