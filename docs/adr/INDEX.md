...
| Full ADR | ADR-0006 | One-Time Local SonarQube Baseline Analysis | Accepted | Verified | Project | N/A — this repository-owner-requested local verification strategy is not derived from Trello product demand | `docs/adr/ADR-0006-one-time-local-sonarqube-baseline-analysis.md` | None |
