...
| Full ADR | ADR-0008 | Delimiter-Bounded Governance Record Paths | Accepted | Complete | Project | N/A — corrective governance-validator work requested from the local SonarQube result, not derived from product demand | `docs/adr/ADR-0008-delimiter-bounded-governance-record-paths.md` | None |
| Full ADR | ADR-0009 | Accepted-Record Validator Reliability | Accepted | Complete | Project | N/A — corrective governance-validator work requested from the local SonarQube result, not derived from product demand | `docs/adr/ADR-0009-accepted-record-validator-reliability.md` | None |
...
| OCR | OCR-0004 | Local SonarQube Reliability Remediation Verification | Accepted | Complete | Project | `docs/adr/ADR-0008-delimiter-bounded-governance-record-paths.md`, subtask T-3 | `docs/adr/ocr/archive/OCR-0004-local-sonarqube-reliability-remediation-verification.md` | None |
| OCR | OCR-0005 | Local SonarQube Accepted-Record Reliability Verification | Accepted | Complete | Project | `docs/adr/ADR-0009-accepted-record-validator-reliability.md`, subtask T-2 | `docs/adr/ocr/archive/OCR-0005-local-sonarqube-accepted-record-reliability-verification.md` | None |
