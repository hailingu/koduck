...
| Full ADR | ADR-0008 | Delimiter-Bounded Governance Record Paths | Proposed | Not Started | Project | N/A — corrective governance-validator work requested from the local SonarQube result, not derived from product demand | `docs/adr/ADR-0008-delimiter-bounded-governance-record-paths.md` | None |
