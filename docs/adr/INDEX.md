...
| Full ADR | ADR-0009 | Accepted-Record Validator Reliability | Proposed | Not Started | Project | N/A — corrective governance-validator work requested from the local SonarQube result, not derived from product demand | `docs/adr/ADR-0009-accepted-record-validator-reliability.md` | None |
