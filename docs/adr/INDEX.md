...
| Lightweight ADR | ADR-0002 | Typed HTTP Wire Serialization | Accepted | Not Started | Service internal — koduck-ai | N/A — corrective internal maintainability work discovered through source review, not derived from product demand | `koduck-ai/docs/adr/ADR-0002-typed-http-wire-serialization.md` | None |
