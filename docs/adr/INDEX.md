...
| Full ADR | ADR-0002 | Required Koduck AI CI And PostgreSQL Verification | Accepted | Blocked | Project | N/A — repository verification governance, not product demand | `docs/adr/ADR-0002-required-ai-ci-postgres-verification.md` | None |
