...
| Full ADR | ADR-0004 | Provider Stream Completion Normalization | Accepted | Not Started | Project | N/A — this corrective provider-protocol compatibility task was discovered through local verification of the existing provider-neutral runtime and is not derived from a new Trello product requirement | `docs/adr/ADR-0004-provider-stream-completion-normalization.md` | None |
