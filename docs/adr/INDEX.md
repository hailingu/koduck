...
| Full ADR | ADR-0003 | Correction Item Schema and Raw Replay | Accepted | Not Started | Service internal — koduck-ai | `docs/architecture/ADD-0001-ai-service-codex-alignment.md` — CAND-3 | `koduck-ai/docs/adr/ADR-0003-correction-item-schema-and-raw-replay.md` | None |
