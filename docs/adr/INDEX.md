...
| Full ADR | ADR-0003 | Default-Deny Tool Approval And Execution Boundary | Accepted | In Progress | Project | `docs/architecture/ADD-0001-ai-service-codex-alignment.md` — CAND-2 | `docs/adr/ADR-0003-default-deny-tool-approval-execution-boundary.md` | None |
