...
| OCR | OCR-0004 | Local SonarQube Reliability Remediation Verification | Accepted | In Progress | Project | `docs/adr/ADR-0008-delimiter-bounded-governance-record-paths.md`, subtask T-3 | `docs/adr/ocr/OCR-0004-local-sonarqube-reliability-remediation-verification.md` | None |
