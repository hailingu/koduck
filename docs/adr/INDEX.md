...
| Full ADR | ADR-0009 | Accepted-Record Validator Reliability | Accepted | In Progress | Project | N/A — corrective governance-validator work requested from the local SonarQube result, not derived from product demand | `docs/adr/ADR-0009-accepted-record-validator-reliability.md` | None |
...
| OCR | OCR-0005 | Local SonarQube Accepted-Record Reliability Verification | Proposed | Not Started | Project | `docs/adr/ADR-0009-accepted-record-validator-reliability.md`, subtask T-2 | `docs/adr/ocr/OCR-0005-local-sonarqube-accepted-record-reliability-verification.md` | None |
