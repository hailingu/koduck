...
| OCR | OCR-0003 | Local SonarQube Security Remediation Verification | Accepted | Blocked | Project | `docs/adr/ADR-0007-linear-time-governance-path-recognition.md`, subtask T-3 | `docs/adr/ocr/OCR-0003-local-sonarqube-security-remediation-verification.md` | None |
