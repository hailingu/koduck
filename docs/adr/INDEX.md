...
| Full ADR | ADR-0001 | Strict JSON Duplicate-Member Validation | Accepted | Not Started | Service internal — koduck-ai | N/A — corrective internal maintainability work discovered through source review, not derived from product demand | `koduck-ai/docs/adr/ADR-0001-strict-json-duplicate-member-validation.md` | None |
