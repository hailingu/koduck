...
| Full ADR | ADR-0007 | Linear-Time Governance Path Recognition | Accepted | In Progress | Project | N/A — corrective security work requested against the local SonarQube project, not derived from product demand | `docs/adr/ADR-0007-linear-time-governance-path-recognition.md` | None |
