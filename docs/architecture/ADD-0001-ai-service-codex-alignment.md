...
flowchart TB
  ...
  subgraph CF3 ["CF-3 Resume or fork"]
    ...
    CF3ResumeCommit -->|"No, request source, final winner, prefix, or tail drifted"| CF3Drift["Discard stale staged chain; reread current source and committed winner; restart bounded assembly"]
...
- [ ] Repository owner and required approver `@linhai` must review the complete producer-failure exit, candidate-selection-gate, drift-reassembly, child-cancellation, retry-drift routing, direct-history drift-result, CF-1 durability-exit, CF-3 drift-recovery, and Resume-cancellation corrections for automatic reviews `5085863664`, `5085923290`, `5086121809`, `5086269808`, and `5086388217` and respond with exact `Approve`; active approval metadata remains pending and Design Status is `Draft`.
