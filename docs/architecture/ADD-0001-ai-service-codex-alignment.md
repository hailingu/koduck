...
- **Approval Time [Conditionally Required — Design Status is or has been `Current`]**: 2026-09-02T13:15:25+08:00
...
- [x] Repository owner and required approver `@linhai` reviewed the complete transactional-failure exit correction for automatic review `5085774823` and responded with exact `Approve`; active approval metadata records that reapproval and Design Status is `Current`.
