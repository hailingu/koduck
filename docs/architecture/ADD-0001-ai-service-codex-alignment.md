...
- [ ] Repository owner and required approver `@linhai` must review the complete producer-failure exit correction for automatic review `5085863664` and respond with exact `Approve`; active approval metadata remains pending and Design Status is `Draft`.
