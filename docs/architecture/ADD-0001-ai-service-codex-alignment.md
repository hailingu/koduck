...
- **Approval Time [Conditionally Required — Design Status is or has been `Current`]**: 2026-09-01T22:20:43+08:00
...
- [x] Repository owner and required approver `@linhai` reviewed the CAND-14 context-compaction revision, including the corrected CF-3 Mermaid paths, and responded with exact `Approve` in the active task at `2026-09-01T22:20:43+08:00`; active approval metadata is complete and Design Status is `Current`.
