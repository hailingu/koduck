...
flowchart TB
  ...
  subgraph CF3 ["CF-3 Resume or fork"]
    ...
    CF3Operation -->|"Fork"| CF3ForkScope["Reserve unpublished child identity and immutable lineage"]
