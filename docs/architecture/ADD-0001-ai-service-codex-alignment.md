...
flowchart TB
  ...
  subgraph CF3 ["CF-3 Resume or fork"]
    ...
    CF3Operation -->|"Fork"| CF3ForkScope["Reserve unpublished child identity and immutable lineage; an already-committed child for this reservation validates and returns as the idempotent result"] --> CF3Budget
    ...
    CF3ForkWinner -->|"Missing or mismatched"| CF3Inconsistent["Report typed inconsistent-child-state failure; the committed child remains visible; no zero-state abort"]
