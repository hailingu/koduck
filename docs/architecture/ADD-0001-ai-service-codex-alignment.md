              ...
              alt Earliest non-identical member conflict
                ...
                loop Bounded request-drift recovery until the reassembled chain commits or the drift budget ends
                  ...
                  alt Reassembly fails or the drift or pass budget ends
                    ...
                    Store-->>Core: Final chain winner plus Turn committed, another drift or earliest conflict, or typed zero-mutation durability failure
              ...
              alt Earliest non-identical member conflict
                ...
                loop Bounded request-drift child recovery until the reassembled child chain commits or the drift budget ends
                  ...
                  alt Cancellation wins during child reassembly
                    ...
                    Store-->>Core: Final child-chain winner and child state, another drift or earliest conflict, or typed zero-mutation durability failure
...
- [ ] Repository owner and required approver `@linhai` must review the complete producer-failure exit, candidate-selection-gate, drift-reassembly, child-cancellation, retry-drift routing, and direct-history drift-result corrections for automatic reviews `5085863664`, `5085923290`, `5086121809`, and `5086269808` and respond with exact `Approve`; active approval metadata remains pending and Design Status is `Draft`.
