...
- **Approval Time [Conditionally Required — Design Status is or has been `Current`]**: 2026-09-02T13:04:13+08:00
...
- [x] Repository owner and required approver `@linhai` reviewed the complete canonical D-9 identity correction for automatic review `5085510111` and responded with exact `Approve`; active approval metadata records that reapproval and Design Status is `Current`.
